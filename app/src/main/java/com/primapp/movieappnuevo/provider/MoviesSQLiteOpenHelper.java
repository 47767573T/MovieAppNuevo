...
public class MoviesSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_TABLE_PELICULAS = "CREATE TABLE IF NOT EXISTS "
            ...
            + PeliculasColumns.ORIGINALTITLE + " TEXT, "
            + PeliculasColumns.OVERVIEW + " TEXT, "
            + PeliculasColumns.RELEASEDATE + " TEXT, "
            + PeliculasColumns.POSTERPATH + " TEXT, "
            + PeliculasColumns.POPULARITY + " REAL, "
            + PeliculasColumns.VOTEAVERAGE + " REAL, "
            + PeliculasColumns.VOTECOUNT + " INTEGER "
            + " );";
